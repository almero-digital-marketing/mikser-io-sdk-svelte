...
In the Svelte SDK, `useDocument` and `useDocuments` wrap that primitive
in runes-backed reactives. Their callers (`ArticleIndex.svelte`,
`ArticleView.svelte`, etc.) write idiomatic Svelte and get live updates
for free.

To see it: open this article in any of the three Svelte examples, then
