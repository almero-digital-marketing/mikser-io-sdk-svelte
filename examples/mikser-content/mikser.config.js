...
//    so `useDocument` / `useDocuments` / `live()` work in the Svelte apps
...
//  - cors is on by default so the Svelte dev servers on different ports
//    can fetch + subscribe without extra config
...
export default {
    plugins: [
        ...
        layouts({
            ...
            // of meta.layout. The Svelte apps do their own per-component
